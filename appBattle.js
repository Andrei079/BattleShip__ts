document.addEventListener("DOMContentLoaded", function () {
    ...
    Ship.prototype.paint = function () {
        for (var i = 0; i < (Number(this.rare) - 1);) {
            //вычияляем ячейку         
    ...
    var ship2 = new Ship(3, [14, 13]);
    var ship3 = new Ship(4, [51, 52, 53]);
    console.log(fieldNo);
    /*  shipsArr.push(ship); */
    ship3.paintNo();
    console.log(fieldNo);
    ...
    btnFire.addEventListener("click", function () {
        var coord = document.querySelector("#coord").textContent;
        ...
        var coordD = i * 11 + Number(coordX) + 1;
...
//# sourceMappingURL=appBattle.js.map